package com.example.core.view.label;
...
//    private float endPosY;
    ...
    public LabelViewHelper(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        distance = attributes.getDimensionPixelSize(R.styleable.LabelView_label_distance, DEFAULT_DISTANCE);
        height = attributes.getDimensionPixelSize(R.styleable.LabelView_label_height, DEFAULT_HEIGHT);
        strokeWidth = attributes.getDimensionPixelSize(R.styleable.LabelView_label_strokeWidth, DEFAULT_STROKE_WIDTH);
        ...
        textSize = attributes.getDimensionPixelSize(R.styleable.LabelView_label_textSize, DEFAULT_TEXT_SIZE);
