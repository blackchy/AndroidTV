...
import com.example.core.view.ShimmerLayout;

public class LabelShimmerLayout extends ShimmerLayout {

    LabelViewHelper utils;

    public LabelShimmerLayout(Context context) {
        this(context, null);
    }

    public LabelShimmerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LabelShimmerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
