...
public class RecyclerViewTV extends RecyclerView implements View.OnFocusChangeListener {
...
//    private OnInBorderKeyEventListener mOnInBorderKeyEventListener;
    ...
    public RecyclerViewTV(Context context, AttributeSet attrs, int defStyle) {
        ...
        init(context);
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RecyclerViewTV, defStyle, 0);
        final String name = a.getString(R.styleable.RecyclerViewTV_layoutManagerTV);
        if (!TextUtils.isEmpty(name)) {
            createLayoutManager(context, name, attrs, defStyle);
        }
        mSelectedItemCentered = a.getBoolean(R.styleable.RecyclerViewTV_selectedItemIsCenteredTV, false);
        mIsMenu = a.getBoolean(R.styleable.RecyclerViewTV_isMenuTV, false);
        mIsSelectFirstVisiblePosition = a.getBoolean(R.styleable.RecyclerViewTV_isSelectFirstVisiblePositionTV, false);
        mLoadMoreBeforehandCount = a.getInt(R.styleable.RecyclerViewTV_loadMoreBeforehandCountTV, DEFAULT_LOAD_MORE_BEFOREHAND_COUNT);
        mSelectedItemOffsetStart = a.getDimensionPixelOffset(R.styleable.RecyclerViewTV_selectedItemOffsetStartTV, 0);
        mSelectedItemOffsetEnd = a.getDimensionPixelOffset(R.styleable.RecyclerViewTV_selectedItemOffsetEndTV, 0);
        mOptimizeLayout = a.getBoolean(R.styleable.RecyclerViewTV_optimizeLayoutTV, false);
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return RecyclerViewTV.class.getPackage().getName() + '.' + className;
    }
        ...
        if (null != itemView && itemView != this) {
            ...
            if (hasFocus) {
                ...
                if (null != mOnItemListener) {
                    mOnItemListener.onItemSelected(RecyclerViewTV.this, itemView, position);
                }
            } else {
                ...
                if (null != mOnItemListener) {
                    mOnItemListener.onItemPreSelected(RecyclerViewTV.this, itemView, position);
                }
            }
        }
    }
    ...
    public void requestChildFocus(View child, View focused) {
        if (this.mChildViewHolderSelectedListener != null) {
            int pos = this.getPositionByView(child);
            ViewHolder vh = this.getChildViewHolder(child);
            this.mChildViewHolderSelectedListener.onChildViewHolderSelected(this, vh, pos);
        }
    ...
    private int getPositionByView(View view) {
        if (view == null) {
            ...
            return params != null && !params.isItemRemoved() ? params.getViewPosition() : -1;
        }
    }
...
//    }
    ...
    public interface OnChildViewHolderSelectedListener {
         ...
         * @param position
         */
        void onChildViewHolderSelected(RecyclerViewTV parent, ViewHolder vh, int position);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        SavedState superSavedState = (SavedState) super.onSaveInstanceState();
